...
export default function page() {
  return (
    <main className='w-screen h-screen relative bg-gray-100 border border-gray-300 mt-6'>
      <div className='flex flex-col md:flex-row w-full h-full justify-between  md:pt-[120px] px-5 md:px-[25px] py-6 pb-[100px]'>
