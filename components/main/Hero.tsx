    ...
    <main className='w-screen h-auto relative bg-white   '>
      ...
      <div className="hidden md:block mt-6 px-4 py-10 max-w-[700px]">
        ...
        <div className=' px-[5px] mt-[80px] lg:mt-[90px] '>
          ...
          <h2 className='py-3 md:px-5  text-[18px] md:text-[15px]  max-w-[500px] md:max-w-[660px]  px-3'>Welcome to AIT Studio, where creativity knows no bounds.We offer a range of services From captivating indoors and outdoors video recordings to stunning photography, seamless podcast recording, and expert scriptwriting.Book a session with us to unlock your true crative potential.</h2>
          <Link href='/#Pricing'>
          <button className='ml-2 mt-2  uppercase  px-4  lg:px-6 lg:py-4 rounded-md border border-black hover:bg-red-800 py-3 bg-red-700 text-[15px] lg:text-[16px] text-bold text-white'>book a session</button>
          </Link>
        </div>
        <div className=" block md:hidden  px-4 py-10 max-w-[700px]">
            <Image
              src="/studiopic2.jpg"
              alt="aitbackground "
              width={950}
