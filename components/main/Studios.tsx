...
const Studios = () => {
  return (
    <div id='Studio' className='flex flex-col h-auto   justify-center bg-gray-100 items-center border border-gray-400 px-4'>
        <div className='justify-center item-center'>
        <h1 className=' uppercase mt-[45px]  text-[35px] md:text-[65px] underline underline-offset-8 font-bold'>studios</h1>
        </div>
        <div className='grid justify-center items-center gap-2 lg:gap-6 mb-12  px-4 '>
