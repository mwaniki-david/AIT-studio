        ...
        <div className="flex md:flex-row flex-col">
          ...
          <div className="flex flex-col  gap-3 justify-center item-center">
            <div className=" px-[5px] ">
              <h1 className="uppercase mt-10 text-[30px] md:text-[35px] lg:text-[42px] max-w-[600px] md:max-w-[700px] font-bold cursor: pointer">
              ...
              <h3 className='text-[13px] md:text-[25px] px-1 '>The right price for your creativity.</h3>
              <ul className="flex flex-row text-base md:text-1xl justify-start items-start px-4 py-2 gap-12">
